...
err_values_li_v_ri_v = pool.map(rc.calculate_roc, matrix_fusion_list_li_v_ri_v)
...
rc.draw_roc_eer(err_values_li_v_ri_v, "li v, ri v", roc_values[2]["eer"], roc_values[3]["eer"])
